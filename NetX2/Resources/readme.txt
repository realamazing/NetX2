...
Build application
pyinstaller --add-data "NetX2\Resources;NetX2\Resources" --add-data "NetX2\nets;NetX2\nets" --add-data "NetX2\screenshots;NetX2\screenshots" --noconsole --noconfirm NetX2\main4.py
pyinstaller main4.spec
------ BUGS ------
